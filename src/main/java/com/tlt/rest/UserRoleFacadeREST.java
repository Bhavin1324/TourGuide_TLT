...
import com.tlt.entities.UserRolePK;
 ...
 */
@Stateless
@Path("com.tlt.entities.userrole")
public class UserRoleFacadeREST extends AbstractFacade<UserRole> {
    ...
    private UserRolePK getPrimaryKey(PathSegment pathSegment) {
         ...
         * URI path part is supposed to be in form of 'somePath;username=usernameValue;role=roleValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        com.tlt.entities.UserRolePK key = new com.tlt.entities.UserRolePK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.tlt.entities.UserRolePK key = getPrimaryKey(id);
