...
import static com.jwtConfig.Constants.REMEMBER_ME_VALIDITY_SECONDS;
...
public class TokenProvider implements Serializable {
    ...
    public void init() {
        //load from config
        this.secretKey = "my-jwt-secret-key";
        ...
        this.TokenValidity = TimeUnit.HOURS.toMillis(10); //remember me for 10 hours
        this.TokenValidityForRememberMe = TimeUnit.SECONDS.toMillis(REMEMBER_ME_VALIDITY_SECONDS); //for 24 hours;
    ...
    public String createToken(String username, Set<String> authorities, Boolean RememberMe) {
        ...
        System.out.println("Token Provider => in create token");
        return Jwts.builder()
                .setSubject(username)
                .setIssuer("localhost")
    ...
    public JWTCredential getCredentials(String token) {
        Claims claims = Jwts.parser()
                ...
                .getBody();
        System.out.println("Token Provider in getCredentials");
    ...
    public boolean validateToken(String authtoken) {
        try {
            ...
            return true;
             ...
             LOGGER.log(java.util.logging.Level.INFO, "Invalid JWT signature: {0}", e.getMessage());
            return false;
        }
    }
}
